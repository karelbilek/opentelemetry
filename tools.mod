...
require (
	...
	github.com/karelbilek/opentelemetry v1.35.0 // indirect
	github.com/karelbilek/opentelemetry/metric v1.35.0 // indirect
	github.com/karelbilek/opentelemetry/trace v1.35.0 // indirect
