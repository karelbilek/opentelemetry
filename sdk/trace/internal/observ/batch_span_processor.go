...
const (
	...
	ScopeName = "github.com/karelbilek/opentelemetry/sdk/trace/internal/observ"
...
func NewBSP(id int64, qLen func() int64, qMax int64, mp metric.MeterProvider) (*BSP, error) {
	meter := mp.Meter(
		ScopeName,
