...
const (
	...
	// being instrumented.
	manualReaderType = "github.com/karelbilek/opentelemetry/sdk/metric/metric.ManualReader"
)
...
func NewManualReader(
	...
	cfg := newManualReaderConfig(temporalitySelector, aggregationSelector, cardinalityLimitSelector)
	r := &ManualReader{
...
func newManualReaderConfig(
	temporalitySelector TemporalitySelector,
	aggregationSelector AggregationSelector,
	cardinalityLimitSelector CardinalityLimitSelector,
) manualReaderConfig {
	return manualReaderConfig{
		temporalitySelector:      temporalitySelector,
		aggregationSelector:      aggregationSelector,
		cardinalityLimitSelector: cardinalityLimitSelector,
	}
