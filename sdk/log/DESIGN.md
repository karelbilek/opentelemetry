...
`github.com/karelbilek/opentelemetry/sdk/log` provides Logs SDK compliant with the
...
The SDK is published as a single `github.com/karelbilek/opentelemetry/sdk/log` Go module.

The exporters are going to be published as following Go modules:

- `github.com/karelbilek/opentelemetry/exporters/otlp/otlplog/otlploggrpc`
- `github.com/karelbilek/opentelemetry/exporters/otlp/otlplog/otlploghttp`
- `github.com/karelbilek/opentelemetry/exporters/stdout/stdoutlog`
...
The `Record` is designed similarly to [`log.Record`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/log#Record)
...
from `github.com/karelbilek/opentelemetry/attribute`, matching the API representation and
...
Because [`Record`](#record) and [`log.Record`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/log#Record)
are very similar, there was a proposal to embed `log.Record` in `Record` definition.

[`log.Record`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/log#Record)
