...
import (
	...
	"github.com/karelbilek/opentelemetry/sdk/log/internal/x"
...
const (
	...
	ScopeName = "github.com/karelbilek/opentelemetry/sdk/log/internal/observ"
)
...
func NewSLP(id int64, provider metric.MeterProvider) (*SLP, error) {
