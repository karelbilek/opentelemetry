...
TracerProvider from the github.com/karelbilek/opentelemetry package can be used as
a default.
...
[github.com/karelbilek/opentelemetry/trace/embedded]. If an author wants the default
behavior of their implementations to be a compilation failure, signaling to
their users they need to update to the latest version of that implementation,
they need to embed the corresponding interface from
[github.com/karelbilek/opentelemetry/trace/embedded] in their implementation. For
example,
...
can embed the API interface directly.
	...
	import "github.com/karelbilek/opentelemetry/trace"
...
[github.com/karelbilek/opentelemetry/trace], which may be done with a transitive
dependency.
...
[github.com/karelbilek/opentelemetry/trace/noop]:
	...
	import "github.com/karelbilek/opentelemetry/trace/noop"
...
[github.com/karelbilek/opentelemetry/trace/noop] if they choose this default behavior.
