...
// [github.com/karelbilek/opentelemetry/metric/x.Settable][attribute.Set], which can be
...
//
// Experimental: The returned option may implement
// [github.com/karelbilek/opentelemetry/metric/x.Settable][[]attribute.KeyValue], which can be
