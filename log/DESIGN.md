...
`github.com/karelbilek/opentelemetry/log` provides
...
The API is published as a single `github.com/karelbilek/opentelemetry/log` Go module.
...
- `github.com/karelbilek/opentelemetry/log/logtest`
...
[`attribute.Value`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/attribute#Value)
and
[`attribute.KeyValue`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/attribute#KeyValue)
types.
...
The `github.com/karelbilek/opentelemetry/log/noop` package provides
...
[`trace.ContextWithSpanContext`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/trace#ContextWithSpanContext)
and [`trace.NewSpanContext`](https://pkg.go.dev/github.com/karelbilek/opentelemetry/trace#NewSpanContext)
...
The log record resembles the instrument config structs like [metric.Float64CounterConfig](https://pkg.go.dev/github.com/karelbilek/opentelemetry/metric#Float64CounterConfig).
...
to the [Meter API](https://pkg.go.dev/github.com/karelbilek/opentelemetry/metric#Meter)
