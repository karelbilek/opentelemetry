...
const (
	...
	ScopeName = "github.com/karelbilek/opentelemetry/exporters/otlptracehttp/internal/observ"
...
func NewInstrumentation(id int64, endpoint string, mp metric.MeterProvider) (*Instrumentation, error) {
...
func BaseAttrs(id int64, endpoint string) []attribute.KeyValue {
	...
	if err != nil || (host == "" && port < 0) {
		if err != nil {
			global.Warn("failed to parse endpoint", "endpoint", endpoint, "error", err)
		}
